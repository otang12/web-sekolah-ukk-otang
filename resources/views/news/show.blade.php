...
@section('title', $news->title ?: 'Berita SMK Negeri 1 Cijati')
...
<section class="hero-full-wrap container">
    <div class="hero-full" data-hero-bg="{{ $na2Image }}">
        <div class="hero-full__overlay">
            <div class="container">
                <div class="hero-full__inner">
                    <span class="eyebrow">{{ $na2Label }}</span>
                    <h1>{{ $na2Title }}</h1>
                    <p class="hero__desc">{{ $na2Date }} &middot; {{ $na2Author }}</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="na2">
    <article class="container na2-article">
        <div class="na2-meta">
            <span class="na2-meta__badge">{{ $na2Label }}</span>
            <span class="na2-meta__date">{{ $na2Date }}</span>
            <span class="na2-meta__dot">&middot;</span>
            <span class="na2-meta__author">{{ $na2Author }}</span>
        </div>
        ...
        <a href="{{ route('news.index') }}" class="na2-back">&larr; Kembali ke Berita</a>
    </article>
