...
<div class="admin-layout">
    ...
    <aside class="admin-sidebar">
        <div class="admin-sidebar__brand">
            <img src="{{ asset('img/logo-sekolah.png') }}" alt="Logo SMK Negeri 1 Cijati" class="admin-sidebar__brand-icon">
            <div>
        ...
        <nav class="admin-sidebar__nav">
            ...
            <a href="{{ route('admin.jurusan.index') }}" class="admin-sidebar__link {{ request()->routeIs('admin.jurusan.*') ? 'admin-sidebar__link--active' : '' }}">
                <span class="admin-sidebar__link-icon">🏫</span> Jurusan
            </a>
            <a href="{{ route('admin.news.index') }}" class="admin-sidebar__link {{ request()->routeIs('admin.news.*') ? 'admin-sidebar__link--active' : '' }}">
                <span class="admin-sidebar__link-icon">📰</span> Berita
            </a>
            <a href="{{ route('admin.guru.index') }}" class="admin-sidebar__link {{ request()->routeIs('admin.guru.*') ? 'admin-sidebar__link--active' : '' }}">
                <span class="admin-sidebar__link-icon">👩‍🏫</span> Guru &amp; Staf
            </a>
            <a href="{{ route('admin.galeri.index') }}" class="admin-sidebar__link {{ request()->routeIs('admin.galeri.*') ? 'admin-sidebar__link--active' : '' }}">
                <span class="admin-sidebar__link-icon">🖼️</span> Galeri
            </a>
            <a href="{{ route('admin.ekstrakurikuler.index') }}" class="admin-sidebar__link {{ request()->routeIs('admin.ekstrakurikuler.*') ? 'admin-sidebar__link--active' : '' }}">
                <span class="admin-sidebar__link-icon">🏆</span> Ekstrakurikuler
            </a>
        </nav>

        <div class="admin-sidebar__account">
            <img src="{{ asset('img/logo-sekolah.png') }}" alt="Logo SMK Negeri 1 Cijati" class="admin-sidebar__avatar">
    ...
    <main class="admin-main">
        <div class="admin-wrapper">
            @unless(request()->routeIs('admin.dashboard'))
                <a href="{{ route('admin.dashboard') }}" class="admin-back">&larr; Kembali ke Dashboard</a>
            @endunless
