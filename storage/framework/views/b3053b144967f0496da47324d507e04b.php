...
<div class="login-split">
    ...
    <div class="login-split__panel">
        ...
        <div class="login-split__content">
            <img src="<?php echo e(asset('img/logo-sekolah.png')); ?>" alt="Logo SMK Negeri 1 Cijati" class="login-split__logo">
    ...
    <div class="login-split__form-side">
        <div class="login-form-box">
            ...
            <form method="POST" action="<?php echo e(route('login.attempt')); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="nama@email.com">
                    </div>
                </div>
            ...
            <a href="<?php echo e(route('home')); ?>" class="login-back">&larr; Kembali ke Beranda</a>
        </div>
    </div>
...
</html><?php /**PATH C:\laragon\www\profile-sekolah-dhani-12rpl1\resources\views/auth/login.blade.php ENDPATH**/ ?>