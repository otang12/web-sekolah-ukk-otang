...
<section class="hero-full-wrap container">
    <div class="hero-full" data-hero-bg="<?php echo e(asset('img/hero/ekstrakurikuler-hero.jpeg')); ?>">
...
<section class="container ekskul-bento">
    <?php $__currentLoopData = $ekskuls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ekskul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(route('ekstrakurikuler.show', $ekskul->slug)); ?>"
           class="ekskul-tile <?php echo e($i === 0 ? 'ekskul-tile--feature' : ''); ?>">

            <span class="ekskul-tile__index"><?php echo e(str_pad($i + 1, 2, '0', STR_PAD_LEFT)); ?></span>

            <div class="ekskul-tile__media">
                <?php if($ekskul->fotos->first()): ?>
                    <img src="<?php echo e(asset('storage/' . $ekskul->fotos->first()->file)); ?>" alt="Kegiatan <?php echo e($ekskul->nama); ?>" loading="lazy">
                <?php else: ?>
            ...
            <div class="ekskul-tile__badge">
                ...
                <?php else: ?>
                    <span><?php echo e(substr($ekskul->nama, 0, 1)); ?></span>
                <?php endif; ?>
            </div>

            <div class="ekskul-tile__content">
                <h3><?php echo e($ekskul->nama); ?></h3>
                <p><?php echo e(\Illuminate\Support\Str::limit($ekskul->deskripsi, $i === 0 ? 140 : 90)); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\profile-sekolah-dhani-12rpl1\resources\views/ekstrakurikuler.blade.php ENDPATH**/ ?>