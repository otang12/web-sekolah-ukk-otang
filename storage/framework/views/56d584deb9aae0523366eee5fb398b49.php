...
<?php $__env->startSection('title', 'Program Keahlian'); ?>
...
<section class="hero-full-wrap container">
    <div class="hero-full" data-hero-bg="<?php echo e(asset('img/hero/hero-1.jpeg')); ?>">
    ...
    <section class="container jk2-section">
        ...
        <div class="jk2-grid">
            <?php $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $jk2Border = $jk2Colors[$loop->index % count($jk2Colors)]; ?>
                <a href="<?php echo e(route('jurusan.show', $j->slug)); ?>" class="jk2-card" style="--jk2-accent: <?php echo e($jk2Border); ?>;">
                    <div class="jk2-card__emblem">
                        <?php if($j->logo): ?>
                            <img src="<?php echo e(asset('storage/' . $j->logo)); ?>" alt="Logo <?php echo e($j->nama); ?>">
                        <?php else: ?>
                            <span><?php echo e(substr($j->singkatan, 0, 1)); ?></span>
                        <?php endif; ?>
                    </div>
                    <h3 class="jk2-card__title"><?php echo e($j->nama); ?></h3>
                    <p class="jk2-card__desc"><?php echo e($j->deskripsi); ?></p>
    ...
    <section class="container jk2-section jk2-section--cork" id="fasilitas">
        ...
        <div class="jk2-pinboard" id="jk2Pinboard">
            ...
            <?php $__currentLoopData = $fasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <figure class="jk2-pin" style="--r: <?php echo e($jk2Angles[$loop->index % count($jk2Angles)]); ?>deg;">
                    <span class="jk2-pin__tape"></span>
                    <div class="jk2-pin__photo">
                        <img src="<?php echo e(asset('img/fasilitas/' . \Illuminate\Support\Str::slug($f) . '.jpeg')); ?>" alt="<?php echo e($f); ?>" loading="lazy">
                    </div>
                    <figcaption class="jk2-pin__caption">
                        <span class="jk2-pin__no">No. <?php echo e(sprintf('%02d', $loop->iteration)); ?></span>
                        <?php echo e($f); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\profile-sekolah-dhani-12rpl1\resources\views/jurusan.blade.php ENDPATH**/ ?>